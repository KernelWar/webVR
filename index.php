...
<body>
    ...
    <a-scene id="escenario">
        ...
        <a-plane color="#33ff93" height="20" width="20" rotation="-90 0 0" material="color: #000124" geometry="height: 18.07; width: 14.31"></a-plane>
        ...
        <a-entity text__titulo="align: center; height: 1.34; letterSpacing: 1.68; tabSize: 7.44; value: Estructura de una molecula de agua; width: 3.9; wrapCount: 15.09" rotation="" position="0.916 8.008 -4.986"></a-entity>
        <a-entity geometry="depth: 0.92" material="src: #diagrama" position="-4.20712 1.144 -3.216" scale="2.304 1.672 -0.096" id="diagrama" rotation="0 -119.99999999999999 0"></a-entity>

        <a-entity id="tierra" animation="property: rotation; to: 0 360 0; loop: true; dur: 20000; easing: linear;" geometry="primitive: sphere" position="0 1.205 -5.308" material="src: #tierra-texture" scale="0.811 0.811 0.811"></a-entity>

        <a-entity id="info-tierra" geometry="primitive: plane; height: 0.52; width: 1.96" text__info-t="align: center; color: #000000; value: El agua cubre un 71 %\n de la superficie terrestre; wrapCount: 24.06" material="color: #20ae6a" position="0 0.303 -4.208" rotation="-21.361 0 0"></a-entity>

        <a-text align="center" baseline="top" width="16" value="Electrones: 1
            Protones: 1
            Neutrones: 0" position="-3.297 3.346 -4.849" geometry="primitive: plane; skipCache: true; height: 0.93; width: 2.06" text="anchor: center; width: 1.82; align: left; baseline: center; value: Atomo de hidrogeno\nElectrones: 1\nProtones: 1\nNeutrones: 0\n; wrapCount: 23.22; tabSize: 0; zOffset: 0.02" wrap-count="80" id="info-h1" rotation="0 22.355 0" material="transparent: true; vertexColors: face; blending: multiply; ambientOcclusionMapIntensity: 2.75; ambientOcclusionTextureOffset: 0.38 -0.05; color: #1676a9; emissive: #000000; emissiveIntensity: 4.52; width: 100">
        </a-text>

        <a-entity rotation="0 0 20" id="atomo-h" position="-2 2 -4">
            <a-entity rotation="0 360 0" animation="property: rotation; to: 0 0 360; loop: true; dur: 1000; easing: linear;">
        ...
        <a-text align="center" baseline="top" width="16" value="Electrones: 1
        Protones: 1
        Neutrones: 0" position="-0.056 5.953 -3.393" geometry="primitive: plane; skipCache: true; height: 0.93; width: 2.06" text="anchor: center; width: 1.82; align: left; baseline: center; value: Atomo de oxigeno\nElectrones: 8\nProtones: 8\nNeutrones: 8\n; wrapCount: 23.22; tabSize: 0; zOffset: 0.02" wrap-count="80" id="info-o" rotation="22.605 0 0" material="vertexColors: face; blending: multiply; color: #09aa00; width: 100; flatShading: true; shader: flat">
        </a-text>
        ...
        <a-entity rotation="0 0 0" id="atomo-o" position="0 4 -4">
            ...
            <a-entity rotation="0 360 0" animation="property: rotation; to: 0 0 360; loop: true; dur: 1500; easing: linear;">
            ...
            <a-entity rotation="0 0 0" animation="property: rotation; to: 360 0 0; loop: true; dur: 1900; easing: linear;">
            ...
            <a-entity rotation="10 0 0" animation="property: rotation; to: 0 360 0; loop: true; dur: 2000; easing: linear;">
            ...
            <a-entity rotation="0 188 0" animation="property: rotation; to: 0 0 360; loop: true; dur: 2600; easing: linear;">
            ...
            <a-entity rotation="0 0 140" animation="property: rotation; to: 0 360 0; loop: true; dur: 3000; easing: linear;">
            ...
            <a-entity rotation="0 0 330" animation="property: rotation; to: 360 0 0; loop: true; dur: 700; easing: linear;">
            ...
            <a-entity rotation="120 0 0" animation="property: rotation; to: 0 360 0; loop: true; dur: 800; easing: linear;">
        ...
        <a-entity rotation="30 0 0" id="atomo-h2" position="2 2 -4">
            <a-entity rotation="0 0 360" animation="property: rotation; to: 0 360 0; loop: true; dur: 1200; easing: linear;">
